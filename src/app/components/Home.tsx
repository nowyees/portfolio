    ...
    >
      ...
      <nav className="fixed top-0 w-full flex justify-between items-center px-6 pt-4 pb-0 md:px-12 z-50 mix-blend-difference text-[#f7f6f0] md:mix-blend-normal md:text-[#111]">
        <div className="flex-none">
          <button onClick={() => { scrollContainerRef.current?.scrollTo({ top: 0, behavior: 'smooth' }) }} className="text-[7px] md:text-[9px] font-bold md:font-medium uppercase tracking-wider md:tracking-widest transition-opacity hover:opacity-50">LEE JAEWOONG</button>
        </div>
